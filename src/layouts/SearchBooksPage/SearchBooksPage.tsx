...
import { SerchBook } from "./components/SearchBook";
...
export const SearchBooksPage = () => {
    ...
    const [totalAmountOfBooks, setTotalAmontOfBooks] = useState(0);
    ...
    useEffect(() => {
        const fetchBooks = async () => {
            ...
            setTotalAmontOfBooks(responseJson.page.totalElements);
        ...
        //to scroll to top each time we call this event
        window.scroll(0, 0);
    ...
    const indexOfFirsttBook: number = indexOfLastBook - booksPerPage;
                ...
                <div>
                        ...
                        <div className='col-6'>
                            <div className='d-flex'>
                                ...
                                <button className='btn btn-outline-success'
                                    onClick={() => serachHandelChange()}>Search</button>
                            </div>
                        </div>
                        <div className='col-4'>
                    ...
                    {totalAmountOfBooks > 0 ?
                        <>
                            ...
                            <p>
                                {indexOfFirsttBook + 1} to {lastItem} of {totalAmountOfBooks} items:
                            </p>
                            {books.map(book => (
                                <SerchBook book={book} key={book.id} />
                            ))}
                        </> :
                        <div className="m-5">
